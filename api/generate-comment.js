...
const OPENER_STYLES = [
  ...
  'Open with what changed for this learner this term — a shift in effort, confidence, or output.',
  'Open with something this learner surprised you with.',
  'Open with the gap between their potential and their output, or the absence of that gap.',
  'Open with a habit or pattern that showed up consistently across the term.',
  'Open with the subject or skill they find hardest and what that reveals about them.',
  'Open with how they carry themselves academically — their confidence in the room.',
  'Open with the arc of the term — where they started versus where they finished.',
  'Open with their strongest contribution or moment from the term.',
  'Open with how they handle difficulty or setback.',
  'Open with their independence — how much they drive their own learning.',
  'Open with their presence in class: engagement, energy, participation.',
  'Open with what their written or spoken work reveals about how they think.',
  'Open with what you notice when this learner is working at their best.',
  'Open with a specific strength and the complication that comes with it.',
  'Open with something about this learner that their marks alone wouldn\'t tell you.',
  'Open with the contrast between two things that are both true about this learner.',
  'Open with what this learner needs to hear most right now.',
  'Open with what they\'re ready for — the next challenge or expectation.',
  'Open with a specific task, topic, or piece of work and what it showed.',
  'Open with how their peers experience working alongside them.',
  'Open with a question this learner is still working through, academically or personally.',
  'Open with what you hope this learner takes with them from this term.',
];
